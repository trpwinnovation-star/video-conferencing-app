...
import { Video, Download, Loader2, ArrowLeft, Calendar, Clock, AlertCircle } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto mt-12 px-6">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-extrabold tracking-tight text-stone-900 flex items-center gap-3">
            <Video className="text-[#c16d18]" size={28} />
            My Meetings
          </h1>
        </div>
        ...
        {recordings.length === 0 && !error ? (
          <div className="bg-white border border-stone-200/80 rounded-2xl p-12 text-center shadow-xl">
            ...
            <h3 className="text-lg font-bold text-stone-900 mb-2">No meetings yet</h3>
